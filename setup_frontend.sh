            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  <Link to="/" className="text-white font-bold text-xl">NR Tax Solutions</Link>
                </div>
    ...
    <footer className="bg-primary-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">NR Tax Solutions</h3>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <p className="text-center text-gray-300 text-sm">
            &copy; {new Date().getFullYear()} NR Tax Solutions. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
      ...
      <div className="py-12 bg-primary-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-xl">
            Join thousands of international students and professionals who trust NR Tax Solutions.
          </p>
          <div className="mt-8">
            <Link
              to="/register"
        ...
        <div className="mt-12 bg-primary-700 rounded-lg shadow-xl overflow-hidden">
          <div className="px-4 py-8 sm:px-6 sm:py-12 text-center">
            ...
            <p className="mt-2 text-lg leading-6 text-primary-100">
              Join thousands of non-residents who trust NR Tax Solutions for reliable tax guidance.
            </p>
